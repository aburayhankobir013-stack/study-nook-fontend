  ...
  return (
    <div className="min-h-screen container mx-auto border flex flex-col justify-center items-center bg-green-100 p-4 gap-4">
      ...
      <div className="flex flex-col items-center text-center gap-1 px-4">
        ...
        <h1 className="font-bold text-xl text-green-900">Add A New Room</h1>
        <p className="font-semibold text-green-700">
          Share your study room with others. You can edit or remove it anytime
        </p>
      </div>
      <form
      ...
      >
        <div className="flex flex-col gap-1">
          <label htmlFor="room_name" className="font-bold text-green-500">
            Room Name
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="description" className="font-bold text-green-500">
            Description
          </label>
          <textarea
            id="description"
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="image_url" className="font-bold text-green-500">
            Image URL
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col border p-4 rounded-xs gap-2">
          <div className="flex flex-col gap-1">
            <label htmlFor="floor" className="font-bold text-green-500">
              Floor
            </label>
            <input
              type="number"
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="capacity" className="font-bold text-green-500">
              Capacity
            </label>
            <input
              type="number"
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="rate" className="font-bold text-green-500">
        ...
        >
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-1 w-full">
            ...
            <div className="flex items-center gap-1 border px-2 py-1 rounded-xs bg-green-50">
              <input
                ...
                {...register("anemities")}
              />
              <label htmlFor="power_outlets" className="font-semibold">
                Power Outlets
              </label>
            </div>
            <div className="flex items-center gap-1 border px-2 py-1 rounded-xs bg-green-50">
            ...
            <div className="flex items-center gap-1 border px-2 py-1 rounded-xs bg-green-50">
              <input
                ...
                {...register("anemities")}
              />
              <label htmlFor="air_conditioning" className="font-semibold">
                Air Conditioning
              </label>
            </div>
          </div>
          {errors.anemities && (
            <>
              <p className="text-red-500">{errors.anemities.message}</p>
            </>
          )}
        </div>
        <div>
